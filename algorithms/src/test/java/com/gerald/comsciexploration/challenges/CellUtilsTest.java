...
import static com.gerald.comsciexploration.challenges.CellUtils.initializeList;
...
class CellUtilsTest {
    ...
    @Test
    void copy() {
        Cell<Integer> linkedListOne = initializeList(sentinel(),
                1, 2, 3, 4, 5);
    ...
    @Test
    void size(){
        assertEquals(5, CellUtils.size(initializeList(sentinel(),
                1, 2, 3, 4, 5)));
    }
    ...
    @Test
    void getLast(){
        assertEquals((Integer) 5, CellUtils.getLast(initializeList(sentinel(),
                1, 2, 3, 4, 5)).getValue());
    }
}